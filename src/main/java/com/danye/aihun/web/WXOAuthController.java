...
public class WXOAuthController {
    ...
    public String permOA2Callback(@RequestParam(value = "callbackUrl", required = false) String callbackUrl,
        ...
        if (!"authdeny".equals(oauth_code) && !"".equals(oauth_code) && null != oauth_code) {
            ...
            if (oauth_state.equals(Constants.WECHAT_AUTH_LOGIN) && null == user) {
            ...
            return "redirect:" + callbackUrl + (callbackUrl.contains("?") ? "&" : "?") + "userId=" + (null == user ? "" : user.getUserId()) + "&" + Constants.WECHAT_PERM_FLAG + "=" + oauth_state;
        }
        return null;
    }
